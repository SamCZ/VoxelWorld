...
public class ChunkRenderer {
	...
	public ChunkRenderer(int chunkX, int chunkZ, World world, List<Block> blockDefines, GameObject gameObject, Material[] materials) {
        this.chunkX = chunkX;
        this.chunkZ = chunkZ;
        this.world = world;
    ...
    private void updateBounds() {
        this.boundingBox = new Bounds(new Vector3(this.chunkX * CHUNK_SIZE + 8, CHUNK_SIZE / 2, this.chunkZ * CHUNK_SIZE + 8), new Vector3(CHUNK_SIZE, CHUNK_SIZE, CHUNK_SIZE));
    }
    ...
    private void updateObject() {
        ...
        obj.transform.position = new Vector3(this.chunkX * CHUNK_SIZE, 0, this.chunkZ * CHUNK_SIZE);
        this.updateBounds();
    }
    ...
    private byte getBlockId(int x, int y, int z) {
        return this.world.getBlockId(this.chunkX * CHUNK_SIZE + x, y, this.chunkZ * CHUNK_SIZE + z);
    }
    ...
    public void update(Vector3 player) {
        if(this.lastVisibilityState != this.isVisible) {
            ...
            this.obj.SetActive(this.isVisible ? true : this.isPlayerStandingOn(player));
        }
    ...
    public override string ToString() {
        return "Chunk(x=" + this.chunkX + ",z=" + this.chunkZ + ")";
    }
}
